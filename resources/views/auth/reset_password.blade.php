                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="wrapper-page">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('password.update') }}" role="form" data-parsley-validate novalidate>
                                @csrf
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input id="pass1" class="form-control" type="password" placeholder="Enter Your Email" name="password" autocomplete="new-password">
                                    </div>
                                    @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="password" placeholder="Enter Your Email" name="password_confirmation" data-parsley-equalto="#pass1" autocomplete="new-password">
                                    </div>
