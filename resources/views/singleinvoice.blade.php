                ...
                <div class="row">
                    <div class="col-6">
                        <div class="pull-left mt-3">
                            @if ($invoice_info->customer_id == null)
                                <p><b>Hello,Customer</b></p>
                            @else
                                <p><b>Hello, {{ customer($invoice_info->customer_id)->name }}</b></p>
                            @endif
                    ...
                    <div class="col-4 offset-2">
                        <div class="mt-3 pull-right">
                            ...
                            @if ($invoice_info->customer_id != null)
                                <p title="Phone"><strong>Phone:</strong> {{ $invoice_info->customer_phone }} </p>
                                <h5>Billing Address:</h5>
                                <address class="line-h-24">
                                    {{ customer($invoice_info->customer_id)->address }}
                                </address>
                            @endif
                        </div>
                    </div><!-- end col -->
